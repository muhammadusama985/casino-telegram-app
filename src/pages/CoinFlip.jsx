...
import Lottie from "lottie-react";
import bgAnim from "../assets/lottie/Flipcoin_background.json"; // looping ring
import flipCoinAnim from "../assets/lottie/Flipcoin.json"; // the new coin animation
...
/* ===================== LOTTIE COIN with WAIT->RESOLVE flow (H/T faces) ===================== */
const LottieCoin = forwardRef(function LottieCoin(props, ref) {
