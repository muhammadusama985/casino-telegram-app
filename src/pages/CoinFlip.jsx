      ...
      <div className="flex items-center justify-between px-6 mt-4">
        ...
        >
          ...
          >
            <Lottie
              ...
              style={{
                ...
                height: "100%",
                pointerEvents: "none",
                transform: "translateY(-2px) scale(1)",   // ⬅️ was translateY(-6px) scaleX(1.14) scaleY(1.08)
          ...
          >
            ...
            <div style={{ transform: "translate(-0px, -2px) scale(0.54)", transformOrigin: "center" }}>
  ...
  return (
    <div className="coinflip-scene" style={{ perspective: "1200px" }}>
      <div
        ...
        style={{
          ['--size']: '220px',        // base footprint (shrinked by wrapper scale)
          ['--thickness']: '16px',
        }}
      >
        {/* FRONT → Heads = H */}
