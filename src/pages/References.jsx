...
export default function References() {
    ...
    async function load() {
        setError("");
        try {
            // 👉 smart summary with fallbacks (no console needed)
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/70 p-4">
                ...
                <div className="flex items-center justify-between gap-3">
                    ...
                    <button
                        ...
                        className={`px-3 py-2 rounded-lg text-sm ${canClaimToday ? "bg-emerald-600 hover:bg-emerald-500" : "bg-zinc-700 cursor-not-allowed"
                            }`}
                    >
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/70 p-4 space-y-4">
                ...
                <div className="text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      // in src/pages/References.jsx, inside render
<input
  readOnly
...
<div className="text-xs opacity-80 mt-2 break-all">
  {summary?.referralLink || "(no referral link returned)"}
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/70 p-4">
                ...
                {/* On-screen payload inspector (for mobile, no console needed) */}
